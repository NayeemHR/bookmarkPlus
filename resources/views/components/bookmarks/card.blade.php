...
<x-panel class="flex flex-row ">
    ...
    <div class="flex flex-col w-3/5 p-4">
        ...
        <div class="py-2 ">
            <h3 class="group-hover:text-blue-600 text-xl font-bold transition-colors duration-300"><a href="{{$bookmark->url}}" target="_blank">{{$bookmark->title}}</a></h3>
            {{-- <p class="text-sm mt-2">{{ $bookmark->notes}}</p> --}}
        </div>
