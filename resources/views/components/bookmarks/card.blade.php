...
<tr class="hover:bg-cyan-50 hover:shadow-lg rounded-lg">
          <td class="pl-5 pr-2 border dark:border-darkmode-300 w-10 relative py-0 box  first:border-l last:border-r first:rounded-l-[0.6rem] last:rounded-r-[0.6rem] rounded-l-none rounded-r-none border-x-0 dark:bg-darkmode-600">
            ...
            <td class=" pl-2 pr-5 py-3 border dark:border-darkmode-300 box  first:border-l last:border-r first:rounded-l-[0.6rem] last:rounded-r-[0.6rem] rounded-l-none rounded-r-none border-x-0 dark:bg-darkmode-600">
              <div class="flex items-center">
                
                <div class="ml-3.5">
                  <a href="{{$bookmark->url}}" class="font-medium hover:font-semibold">{{Str::limit($bookmark->title, 25, '...')  }}</a>
                  <div class="">
