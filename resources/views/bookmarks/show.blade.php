                    ...
                    <div class="nc-SingleHeader ">
                        <div class="space-y-5">
                          <div class="nc-CategoryBadgeList flex flex-wrap space-x-2" data-nc-id="CategoryBadgeList">
                            ...
                            <h1 class=" text-neutral-900 font-semibold text-3xl md:text-4xllg:text-5xl dark:text-black-100 max-w-4xl font-heading" title="Trending web &amp; landing page designs in 2023">{{ $bookmark->title }}
                            </h1>
                          ...
                          <div class="flex flex-col sm:flex-row justify-between sm:items-end space-y-5 sm:space-y-0 sm:space-x-5 rtl:space-x-reverse">
                            <div class="nc-PostMeta2 flex items-center flex-wrap text-neutral-700 text-left dark:text-neutral-200 text-sm leading-none flex-shrink-0">
                              <a class="flex items-center space-x-2 rtl:space-x-reverse" href="/author/the-demo-author-slug">
                                <div class="wil-avatar relative flex-shrink-0 inline-flex items-center justify-center overflow-hidden text-neutral-100 uppercase font-semibold rounded-full shadow-inner h-10 w-10 sm:h-11 sm:w-11 text-xl ring-1 ring-white ">
                                  <img src="{{$bookmark->user->profile_photo_url}}" alt="Foulcher Nathanil" loading="lazy" decoding="async" data-nimg="fill" class="absolute inset-0 w-full h-full object-cover" style="position:absolute;height:100%;width:100%;left:0;top:0;right:0;bottom:0;color:transparent" sizes="100px">
                                </div>
                              </a>
                              <div class="ms-3 text-neutral-700 ">
                                <div class="flex items-center">
                                  <a class="block font-semibold" href="/author/the-demo-author-slug">{{$bookmark->user->name}}</a>
                                </div>
                                <div class="text-xs mt-[6px]">
                                  <span class="text-neutral-700">{{ \Carbon\Carbon::parse($bookmark->created_at)->format('d-m-Y') }}</span>
                      ...
                      <div id="single-entry-content" class="mt-6 dark:prose-invert border w-full rounded-lg p-4 text-natural-700" >
                        <h4>Notes:</h4>
                        <p>
                            {{$bookmark->notes}}
                        </p>
